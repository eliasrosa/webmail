...
CMessageListCentralPane.prototype = {
	...
	GetSearchResultsFromBig: function ()
	{
		...
		if (screen) {
			screen.GetSearchResultsFromBig();
		}
	},
	...
	_buildAdditionalBar: function ()
	{
		...
		// var searchParts = this._toolBar.AddSearchItems(this._additionalBar, true);
		...
		this.SearchFormObj = new CSearchForm(this._bigSearchForm, searchParts.SmallForm, searchParts.DownButton.Cont,
			searchParts.UpButton.Cont, this.SearchFormId, this._lookForBigObj, searchParts.LookFor, true);
...
CMessageListCentralPane.prototype.GetSearchResultsFromSmall = MessageListPrototype.GetSearchResultsFromSmall;
