...
function CMessageListTopPaneScreen(skinName)
{
	...
	this._buildToolBar = function (PopupMenus)
	{
		...
		//new message tool
		toolbar.AddItem(TOOLBAR_NEW_MESSAGE, function () {SetHistoryHandler({ScreenId: SCREEN_NEW_MESSAGE});}, true);
		//check mail tool
		...
		this.SearchFormObj = new CSearchForm(this._bigSearchForm, searchParts.SmallForm, searchParts.DownButton.Cont, searchParts.UpButton.Cont, this.SearchFormId, this._lookForBigObj, searchParts.LookFor);
	...
	this.GetSearchResultsFromBig = function()
	{
