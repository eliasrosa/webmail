...
CMessageLine.prototype = 
{
    ...
    _getSubjectContent: function ()
    {
	    if (this.Replied && this.Forwarded) {
	        return '<span class="wm_inbox_lines_rpl_fwd" title="' + Lang.RepliedForwardedMessageTitle + '"></span>' + this.MsgSubject;
	    }
	    if (this.Replied) {
	        return '<span class="wm_inbox_lines_replied" title="' + Lang.RepliedMessageTitle + '"></span>' + this.MsgSubject;
	    }
	    if (this.Forwarded) {
	        return '<span class="wm_inbox_lines_forwarded" title="' + Lang.ForwardedMessageTitle + '"></span>' + this.MsgSubject;
	    }
