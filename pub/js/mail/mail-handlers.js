...
function ViewMessageInNewTab(msg)
{
	...
	inp = CreateChild(form, 'input', [['type', 'hidden'], ['value', '5'], ['name', 'start']]);
	inp = CreateChild(form, 'input', [['type', 'hidden'], ['value', msg.Id], ['name', 'msg_id']]);
	inp = CreateChild(form, 'input', [['type', 'hidden'], ['value', msg.Uid], ['name', 'msg_uid']]);
	inp = CreateChild(form, 'input', [['type', 'hidden'], ['value', msg.FolderId], ['name', 'folder_id']]);
	inp = CreateChild(form, 'input', [['type', 'hidden'], ['value', msg.FolderFullName], ['name', 'folder_full_name']]);
	inp = CreateChild(form, 'input', [['type', 'hidden'], ['value', msg.Charset], ['name', 'charset']]);
	inp = CreateChild(form, 'input', [['type', 'hidden'], ['value', msg.Parts], ['name', 'mode']]);
	inp = CreateChild(form, 'input', [['type', 'hidden'], ['value', msg.Size], ['name', 'size']]);
	form.submit();
}
