...
CFoldersPane.prototype = 
{
	...
	_buildToolBar: function ()
	{
		...
		this._toolBar.AddItem(TOOLBAR_NEW_MESSAGE, function () {SetHistoryHandler({ScreenId: SCREEN_NEW_MESSAGE});}, true);
	},
...
CFolderParams.prototype = {
	...
	SetFolderNameText: function ()
	{
		...
		if (this.MsgsCount > 0) {
			if (this._type == FOLDER_TYPE_TRASH || this._type == FOLDER_TYPE_TRASH_SYNC) {
				...
				ediv.innerHTML = '&nbsp;';
			} else if (this._type == FOLDER_TYPE_SPAM || this._type == FOLDER_TYPE_SPAM_SYNC) {
