...
function CSettings()
{
	...
	this.DefLang = null;
	this.Langs = Array();
	/*this.MobileSyncUrl = null;
	this.MobileSyncLogin = null;
	this.MobileSyncContactDataBase = null;
	this.MobileSyncCalendarDataBase = null;
	this.EnableMobileSyncGlobal = null;
	this.EnableMobileSyncUser = null;*/
}
...
CSettings.prototype = {
	...
	GetInXML: function ()
	{
		...
		/*if (this.EnableMobileSyncUser != null) {
			attrs += (this.EnableMobileSyncUser) ? ' mobile_sync_enable_account="1"' : ' mobile_sync_enable_account="0"';
		}
		if (this.EnableMobileSyncGlobal != null) {
			attrs += (this.EnableMobileSyncGlobal) ? ' mobile_sync_enable_system="1"' : ' mobile_sync_enable_system="0"';
		}*/
		var nodes = '';
		...
		/*if (this.MobileSyncUrl != null) {
			nodes += '<mobile_sync_url>' + GetCData(this.MobileSyncUrl) + '</mobile_sync_url>';
		}
		if (this.MobileSyncContactDataBase != null) {
			nodes += '<mobile_sync_contact_db>' + GetCData(this.MobileSyncContactDataBase) + '</mobile_sync_contact_db>';
		}
		if (this.MobileSyncCalendarDataBase != null) {
			nodes += '<mobile_sync_calendar_db>' + GetCData(this.MobileSyncCalendarDataBase) + '</mobile_sync_calendar_db>';
		}
		if (this.MobileSyncLogin != null) {
			nodes += '<mobile_sync_login>' + GetCData(this.MobileSyncLogin) + '</mobile_sync_login>';
		}*/
	...
	GetFromXML: function(RootElement)
	{
		...
		/*attr = RootElement.getAttribute('mobile_sync_enable_system');if (attr) this.EnableMobileSyncGlobal = attr - 0;
		attr = RootElement.getAttribute('mobile_sync_enable_account');if (attr) this.EnableMobileSyncUser = attr - 0;*/
		...
		for (var i=count-1; i>=0; i--) {
			...
			switch (SettingsParts[i].tagName) {
				/*case 'mobile_sync_url':
					this.MobileSyncUrl = parts[0].nodeValue;
					break;
				case 'mobile_sync_contact_db':
					this.MobileSyncContactDataBase = parts[0].nodeValue;
					break;
				case 'mobile_sync_calendar_db':
					this.MobileSyncCalendarDataBase = parts[0].nodeValue;
					break;
				case 'mobile_sync_login':
					this.MobileSyncLogin = parts[0].nodeValue;
					break;*/
				case 'skins':
					var defSkin = '';
