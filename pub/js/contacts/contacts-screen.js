...
CContactsScreen.prototype = {
	...
	BuildAdvancedSearchForm: function()
	{
		...
		this._lookForBigObj = CreateChild(td, 'input', [['type', 'text'], ['maxlength', '255']]);
	...
	_buildToolBar: function(PopupMenus)
	{
		...
		toolBar.AddItem(TOOLBAR_NEW_MESSAGE, function () { obj.MailContactsTo(); }, true);
		...
		this.SearchFormObj = new CSearchForm(this._bigSearchForm, searchParts.SmallForm, searchParts.DownButton.Cont, searchParts.UpButton.Cont, 'contacts_search_form', this._lookForBigObj, searchParts.LookFor);
