...
INSERT INTO %sawm_domains (
	...
	is_internal, global_addr_book, ldap_auth,
...
UPDATE %sawm_domains SET mail_inc_host = %s, mail_inc_port = %d,
	...
	is_internal = %d, global_addr_book = %d, ldap_auth = %d,
...
SELECT id_domain, %s, mail_protocol, mail_inc_host, mail_inc_port,
	mail_out_host, mail_out_port, mail_out_auth, is_internal, global_addr_book, ldap_auth,
